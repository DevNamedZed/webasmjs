...
import type { BlockTypeDescriptor, HeapTypeRef, OpCodeDef } from './types';
...
export default abstract class OpCodeEmitter {
  ...
  block(blockType: BlockTypeDescriptor, label?: LabelBuilder | ((label: LabelBuilder) => void)): LabelBuilder {
    return this.emit(OpCodes.block, blockType, label);
  }

  loop(blockType: BlockTypeDescriptor, label?: LabelBuilder | ((label: LabelBuilder) => void)): LabelBuilder {
    return this.emit(OpCodes.loop, blockType, label);
  }

  if(blockType: BlockTypeDescriptor, label?: LabelBuilder | ((label: LabelBuilder) => void)): LabelBuilder {
  ...
  try(blockType: BlockTypeDescriptor, label?: LabelBuilder | ((label: LabelBuilder) => void)): LabelBuilder {
    return this.emit(OpCodes.try, blockType, label);
  }

  catch(varUInt32: number): void {
    return this.emit(OpCodes.catch, varUInt32);
  }

  throw(varUInt32: number): void {
    return this.emit(OpCodes.throw, varUInt32);
  }

  rethrow(varUInt32: number): void {
  ...
  br(label: LabelBuilder): void {
    return this.emit(OpCodes.br, label);
  }

  br_if(label: LabelBuilder): void {
    return this.emit(OpCodes.br_if, label);
  }

  br_table(defaultLabel: LabelBuilder, ...labels: LabelBuilder[]): void {
    return this.emit(OpCodes.br_table, defaultLabel, labels);
  }
  ...
  call(func: FunctionBuilder | ImportBuilder): void {
    return this.emit(OpCodes.call, func);
  }

  call_indirect(funcType: FuncTypeBuilder): void {
    return this.emit(OpCodes.call_indirect, funcType);
  }

  return_call(func: FunctionBuilder | ImportBuilder): void {
    return this.emit(OpCodes.return_call, func);
  }

  return_call_indirect(funcType: FuncTypeBuilder): void {
    return this.emit(OpCodes.return_call_indirect, funcType);
  }

  delegate(varUInt32: number): void {
  ...
  get_local(local: LocalBuilder | FunctionParameterBuilder | number): void {
    return this.emit(OpCodes.get_local, local);
  }

  set_local(local: LocalBuilder | FunctionParameterBuilder | number): void {
    return this.emit(OpCodes.set_local, local);
  }

  tee_local(local: LocalBuilder | FunctionParameterBuilder | number): void {
  ...
  ref_func(func: FunctionBuilder | ImportBuilder): void {
    return this.emit(OpCodes.ref_func, func);
  }

  table_get(varUInt32: number): void {
    return this.emit(OpCodes.table_get, varUInt32);
  }

  table_set(varUInt32: number): void {
    return this.emit(OpCodes.table_set, varUInt32);
  }

  load_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load, alignment, offset);
  }

  load8x8_s_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load8x8_s, alignment, offset);
  }

  load8x8_u_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load8x8_u, alignment, offset);
  }

  load16x4_s_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load16x4_s, alignment, offset);
  }

  load16x4_u_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load16x4_u, alignment, offset);
  }

  load32x2_s_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load32x2_s, alignment, offset);
  }

  load32x2_u_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load32x2_u, alignment, offset);
  }

  load8_splat_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load8_splat, alignment, offset);
  }

  load16_splat_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load16_splat, alignment, offset);
  }

  load32_splat_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load32_splat, alignment, offset);
  }

  load64_splat_v128(alignment: number, offset: number): void {
    return this.emit(OpCodes.v128_load64_splat, alignment, offset);
  }

  store_v128(alignment: number, offset: number): void {
  ...
  narrow_i16x8_s_i8x16(): void {
    return this.emit(OpCodes.i8x16_narrow_i16x8_s);
  }

  narrow_i16x8_u_i8x16(): void {
  ...
  add_sat_s_i8x16(): void {
    return this.emit(OpCodes.i8x16_add_sat_s);
  }

  add_sat_u_i8x16(): void {
  ...
  sub_sat_s_i8x16(): void {
    return this.emit(OpCodes.i8x16_sub_sat_s);
  }

  sub_sat_u_i8x16(): void {
  ...
  add_sat_s_i16x8(): void {
    return this.emit(OpCodes.i16x8_add_sat_s);
  }

  add_sat_u_i16x8(): void {
  ...
  sub_sat_s_i16x8(): void {
    return this.emit(OpCodes.i16x8_sub_sat_s);
  }

  sub_sat_u_i16x8(): void {
  ...
  convert_i32x4_s_f32x4(): void {
    return this.emit(OpCodes.f32x4_convert_i32x4_s);
  }

  convert_i32x4_u_f32x4(): void {
  ...
  array_fill(varUInt32: number): void {
    return this.emit(OpCodes.array_fill, varUInt32);
  }

  array_copy(typeIndex: number, index: number): void {
    return this.emit(OpCodes.array_copy, typeIndex, index);
  }

  array_init_data(typeIndex: number, index: number): void {
    return this.emit(OpCodes.array_init_data, typeIndex, index);
  }

  array_init_elem(typeIndex: number, index: number): void {
    return this.emit(OpCodes.array_init_elem, typeIndex, index);
  }

  ref_test(heapType: HeapTypeRef): void {
  ...
  ref_cast(heapType: HeapTypeRef): void {
  ...
  br_on_cast(flags: number, label: LabelBuilder, heapType1: HeapTypeRef, heapType2: HeapTypeRef): void {
    return this.emit(OpCodes.br_on_cast, flags, label, heapType1, heapType2);
  }

  br_on_cast_fail(flags: number, label: LabelBuilder, heapType1: HeapTypeRef, heapType2: HeapTypeRef): void {
    return this.emit(OpCodes.br_on_cast_fail, flags, label, heapType1, heapType2);
  }

  any_convert_extern(): void {
    return this.emit(OpCodes.any_convert_extern);
  }

  extern_convert_any(): void {
  ...
  abstract emit(opCode: OpCodeDef, ...args: any[]): any;
}
